...
<body>
    ...
    <main class="article">
        ...
        <h1>Install Gorp <div class="box green tag">YUM</div></h1>
        ...
        <ol>
            ...
            <li>Run <code>sudo yum -y install java-17-amazon-corretto-devel</code></li>
        </ol>
...
OpenJDK 64-Bit Server VM Corretto-17.0.6.10.1 (build 17.0.6+10-LTS, mixed mode, sharing)</pre>
        ...
        <ol>        
            ...
            <li>Run <code>sudo yum install -y curl wget jq screen</code></li>
