...
<body>
    ...
    <main class="article">
        ...
        <div class="box blue subtle">The Gorp upgrader will ask for your password for elevated privileges via sudo. This is necessary to install program files to the /usr/local/bin/ folder.</div>
